...
<head>
    ...
    <title>Login · RecruitAssist Sprint 1</title>
...
<div class="page-shell narrow-shell">
    <header class="hero-card compact-hero">
        <div class="badge">Sprint 1 Access</div>
        ...
        <div class="hero-metrics section-gap">
            ...
            <div class="hero-metric"><strong>${moCount}</strong><span>Module organisers</span></div>
            <div class="hero-metric"><strong>${adminCount}</strong><span>Admins</span></div>
        </div>
    </header>
        ...
        <section class="panel login-card">
            ...
            <form class="form-grid" method="post" action="${pageContext.request.contextPath}/login">
                <label class="field-group">
                    <span>Username</span>
                    <input class="input" type="text" name="username" value="${username}" required data-login-username />
                </label>
                <label class="field-group">
                    <span>Password</span>
                ...
                <a class="secondary-button" href="${pageContext.request.contextPath}/">Refresh</a>
            </form>
        </section>
